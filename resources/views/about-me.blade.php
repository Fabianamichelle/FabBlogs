        ...
        <main class="mx-auto flex max-w-5xl flex-col gap-10 px-4 pb-16 pt-12 sm:px-6 sm:pb-20 sm:pt-16">
            <section class="grid gap-8 lg:grid-cols-5 lg:items-center lg:gap-10">
                <div class="lg:col-span-3 space-y-4">
                    ...
                    <section>
                        <img src="{{ asset('images/fabby.jpg') }}" alt="fab at coffee shop" class="h-200 w-100 rounded-xl shadow-lg">
                    </section>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="mailto:{{ config('mail.from.address') ?? env('CONTACT_EMAIL', 'fabianamichellee@example.com') }}"
                            class="inline-flex items-center gap-2 rounded-lg bg-zinc-500 px-4 py-2.5 text-sm font-semibold !text-white shadow-sm hover:bg-zinc-800 dark:bg-white !dark:text-black dark:hover:bg-zinc-200">
                            💌 Say hello
                        </a>
